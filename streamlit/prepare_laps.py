...
# Assuming 'data_example_df' is your DataFrame with points
# and 'groupby_column' is the column to group points by (e.g., 'Laps Completed')
# lines_gdf = points_to_lines(data_example_df, 'Laps Completed')
# traj_collection = lines_to_trajectories(lines_gdf)
